...
import { Bot, MessageSquare, Database, Calendar, ChevronDown, CircuitBoard, Cpu, Network } from 'lucide-react';
      ...
      <nav className="fixed w-full z-50 bg-[#0A0B1E]/80 backdrop-blur-lg border-b border-cyan-500/20">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <button className="font-mono bg-gradient-to-r from-cyan-500 to-blue-500 px-6 py-2 rounded-full hover:shadow-lg hover:shadow-cyan-500/20 transition-all">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-3xl">
            ...
            <div className="flex gap-4">
              ...
              <button className="font-mono border border-cyan-500/30 px-8 py-3 rounded-full text-lg font-semibold hover:bg-cyan-500/10 transition-all">
                Explore Solutions
              </button>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-[#0A0B1E]/80 to-[#0A0B1E]">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <button className="font-mono bg-gradient-to-r from-cyan-500 to-blue-500 px-8 py-4 rounded-full text-lg font-semibold hover:shadow-lg hover:shadow-cyan-500/20 transition-all">
